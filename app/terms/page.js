  ...
  return (
    <main className="legalPage">
      ...
      <article className="legalArticle">
        ...
        <h1>이용약관</h1>
        <p className="legalLead">MOVA는 사용자가 목적에 맞는 AI·개발 서비스를 탐색하고 비교할 수 있도록 정보를 제공하는 서비스입니다.</p>
        <section><h2>1. 서비스의 성격</h2><p>MOVA가 제공하는 추천, 설명, 가격 및 기능 정보는 서비스 탐색을 돕기 위한 참고 정보입니다. 실제 요금, 제공 기능, 이용 가능 지역 및 약관은 연결되는 각 서비스의 최신 정보를 기준으로 합니다.</p></section>
        <section><h2>2. 외부 서비스</h2><p>MOVA에서 외부 서비스로 이동하면 해당 서비스의 이용약관과 개인정보처리방침이 적용됩니다. MOVA는 외부 서비스의 운영이나 정책 변경을 직접 통제하지 않습니다.</p></section>
