...
export const guides = [
  {
    ...
    recommendedServices: ["leonardo", "ideogram", "stability", "firefly", "canva"]
  },
  {
    ...
    recommendedServices: ["runway", "kling", "pika", "heygen", "synthesia"]
  },
  {
    ...
    recommendedServices: ["elevenlabs", "heygen", "synthesia"]
  },
  {
    slug: "ai-chatbot-api",
    ...
    recommendedServices: ["openrouter", "google-ai-studio", "deepseek", "cerebras", "cohere", "azure-openai", "bedrock", "vertex-ai"]
  },
  {
    ...
    recommendedServices: ["runway", "pika", "heygen", "elevenlabs", "canva"]
  },
  {
    slug: "free-ai-tools",
    ...
    recommendedTask: "image",
    recommendedServices: ["google-ai-studio", "deepseek", "leonardo", "pika", "canva"]
  }
];
